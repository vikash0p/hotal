      ...
      <main className='container-fluid '>
        <div className="row mt-5">
          <div className="col-12 col-sm-12 col-md-6 col-lg-6">
            <Image src='/images/about.jpg' alt='images' width={600} height={500} className='img-fluid object-fit-fill ' />
          </div>
          <div className="col-12 col-sm-12 col-md-6 col-lg-6 ">
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-sm-12 col-md-4 col-lg-4 my-2">
            <div className="card shadow bg-warning bg-gradient border-0">
              <div className="card-body">
                <h2 className="card-title">01</h2> <br />
                <h4 className="card-subtitle mb-2 text-body-secondary">Lorem Ipsum</h4> <br />
          ...
          <div className="col-12 col-sm-12 col-md-4 col-lg-4 my-2">
            <div className="card shadow bg-warning bg-gradient border-0">
              <div className="card-body ">
                <h2 className="card-title">02</h2><br />
                <h4 className="card-subtitle mb-2 text-body-secondary">Repellat Nihil</h4><br />
          ...
          <div className="col-12 col-sm-12 col-md-4 col-lg-4 my-2">
            <div className="card shadow bg-warning bg-gradient border-0">
              <div className="card-body ">
                <h2 className="card-title">03</h2><br />
                <h4 className="card-subtitle mb-2 text-body-secondary">Ad ad velit qui</h4><br />
                <p className="card-text">Molestiae officiis omnis illo asperiores. Aut doloribus vitae sunt debitis quo vel nam quis debitis quo vel nam quis</p>
